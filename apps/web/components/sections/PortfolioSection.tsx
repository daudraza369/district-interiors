...
const corporateLobbyImg = '/portfolio-corporate-lobby.jpg';
const hotelAtriumImg = '/portfolio-hotel-atrium.jpg';
const restaurantImg = '/portfolio-restaurant.jpg';
const villaImg = '/portfolio-villa.jpg';
const mallImg = '/portfolio-mall.jpg';
const coworkingImg = '/portfolio-coworking.jpg';
