...
const oliveTree = '/olive-tree.jpg';
const treeDetail = '/tree-detail.jpg';
const maintenanceTech = '/maintenance-tech.jpg';
...
export function TreeSolutionsPageClient() {
            ...
            >
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <input type="text" name="name" className="w-full px-4 py-3 border border-stone/40 rounded-sm bg-transparent focus:border-night-green focus:outline-none transition-colors" />
                </div>
                <div>
                  <label className="block text-sm text-night-green mb-2 uppercase tracking-wider">Email</label>
                  <input type="email" name="email" className="w-full px-4 py-3 border border-stone/40 rounded-sm bg-transparent focus:border-night-green focus:outline-none transition-colors" />
                </div>
              </div>
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                  <label className="block text-sm text-night-green mb-2 uppercase tracking-wider">Phone</label>
                  <input type="tel" name="phone" className="w-full px-4 py-3 border border-stone/40 rounded-sm bg-transparent focus:border-night-green focus:outline-none transition-colors" />
                </div>
                <div>
                  <label className="block text-sm text-night-green mb-2 uppercase tracking-wider">Project Type</label>
                  <select name="projectType" className="w-full px-4 py-3 border border-stone/40 rounded-sm bg-transparent focus:border-night-green focus:outline-none transition-colors">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <select name="treeType" className="w-full px-4 py-3 border border-stone/40 rounded-sm bg-transparent focus:border-night-green focus:outline-none transition-colors">
                    <option value="">Select type...</option>
                ...
                <div>
                  ...
                  <select name="timeline" className="w-full px-4 py-3 border border-stone/40 rounded-sm bg-transparent focus:border-night-green focus:outline-none transition-colors">
              ...
              <div className="mb-8">
                ...
                <textarea name="message" rows={4} className="w-full px-4 py-3 border border-stone/40 rounded-sm bg-transparent focus:border-night-green focus:outline-none transition-colors resize-none" placeholder="Tell us about your vision..."></textarea>
              </div>
