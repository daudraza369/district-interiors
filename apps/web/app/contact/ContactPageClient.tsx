...
export function ContactPageClient() {
  ...
  return (
    <>
      ...
      <section ref={formRef.ref} id="contact" className="section-padding bg-ivory">
        <div className="container-luxury">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <motion.div
              ...
              transition={{ duration: 0.8, delay: 0.2 }}
            >
              <form onSubmit={handleSubmit} className="bg-stone/20 p-8 md:p-12 rounded-sm">
                ...
                <div className="mb-6">
                  ...
                  <select name="projectType" className="w-full px-4 py-3 border border-stone/40 rounded-sm bg-ivory focus:border-night-green focus:outline-none transition-colors">
                ...
                <Button variant="default" size="lg" className="w-full" type="submit" disabled={submitting}>
